...
public static class Dr
{
    ...
    public static bool Assert(bool condition, string log = "AssertionFailed")
    {
        if (!condition) Debug.LogError(log);
        return condition;
    }

    public static string RecursiveDescription(object obj)
    {
    ...
    private static void AppendObjectDescription(StringBuilder sb, object obj, int indent, string prefix)
    {
        sb.AppendFormat("{0}{1}[{2}] : ", "".PadLeft(indent), prefix, obj == null ? "null" : obj.GetType().ToString());
